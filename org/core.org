  ...
  jobs:
    build:
      ...
      steps:
        ...
        - name: s6v3. Naviserver. Build and push image.
          run: |
            echo "::group::Prepare environment"
            set -a; source ${GITHUB_WORKSPACE}/src/VERSIONS ; set +a;
            export IMAGE_TAG="${BASE_IMAGE_TAG}-${NS_IMAGE_TAG}"
  ...
  jobs:
    checks:
      ...
      steps:
        ...
        - name: s6v3. Naviserver. Build. Check image and container.
          run: |
            echo "::group::Build image"
            set -a; source ${GITHUB_WORKSPACE}/src/VERSIONS ; set +a;
            echo "Build image"
